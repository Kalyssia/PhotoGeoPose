...
PIPELINE_TASK2_TOPK = 100
PIPELINE_TASK2_BATCH_SIZE = 2
PIPELINE_TASK2_NUM_WORKERS = 4
PIPELINE_TASK2_CACHE_PATH = None
PIPELINE_TASK2_QUERY_CACHE_PATH = None
PIPELINE_TASK2_CACHE_ON_GPU = "auto"  # auto | true | false
PIPELINE_MAX_QUERIES = None 
